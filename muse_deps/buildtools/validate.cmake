# validate.cmake - check that every recipe is well-formed
#
...
foreach(_name ${_all_names})
    ...
    foreach(_s ${DEP_SOURCES})
        ...
        if(NOT _nf EQUAL 4)
            ...
            if(_kind STREQUAL "local")
                _v_err("${_name}: local source only allowed for local development, should not be pushed")
            elseif(NOT _kind MATCHES "^(tarball|git)$")
                _v_err("${_name}: DEP_SOURCES unknown kind '${_kind}' in '${_s}'")
            endif()
        endif()
    endforeach()

    # Referenced patch files must exist
...
# NOTE: prebuilt.lock is autogenerated
